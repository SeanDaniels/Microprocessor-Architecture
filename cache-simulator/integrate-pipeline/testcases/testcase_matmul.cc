...
#define R 1024 //row size
#define C (R) //col size
#define N (R*C)//number of elements
...
int main(int argc, char **argv){
    ...
    mips->set_gp_register(1, R); 		//number of elements in an row
    mips->set_gp_register(7, C); 		//number of elements in an column
    mips->set_gp_register(7, C); 		//number of elements in an column(repeating for inner most loop)
    mips->set_gp_register(2, 0xA0000); 	//address of array A
//address of array B ( address of a with an offset = number elements * size of element )
    mips->set_gp_register(3, 0xA0000+N*4); 	
//address of array C ( address of a with an offset = 2*(number elements * size of element) 
