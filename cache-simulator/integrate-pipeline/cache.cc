...
#ifdef FROM_PIPE
//    cout << "Trying to handle addr %#08llX\n" << hex << thisAddress<< endl;
    printf("Trying to handle addr %#010llx\n", thisAddress);
    printf("This tag: %#015llx\n",tagAddress);
    printf("This tag: %#015llx\n",tag);
    cout << "The index of this addr is " << index << endl;
    #endif
...
void cache::increment_memory_accesses(){
    number_memory_accesses++;
}
