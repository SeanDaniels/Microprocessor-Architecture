...
int main(int argc, char **argv) {
  ...
  sim_ooo *ooo =
	  /*new sim_ooo(memory size, reorder buffer size, int res, add res, mult res, load res)*/
	  new sim_ooo(1024 * 1024, // memory size
				  6,           // rob size
  ...
  // initialize data memory and prints its content (for the specified address
  // ranges)
